...
const HomeScreen = ({ navigation }) => {
  ...
  const [notesList, setNotesList] = useState(<ItemListContainer type="new" />)

  function pressHandler() {
    setNotesList(<ItemListContainer type="new" />)
  }

  
  // loginChecker code for auto logout
        ...
        <View style={styles.searchContainer}>
          ...
          <View style={styles.notesTab}>
            ...
            <View style={styles.pairContainer}>
              ...
              <Text style={{ color: "#ffffff", fontSize: 15 }}>Recent Posted</Text>
            </View>

            <View style={styles.pairContainer}>
              <View style={styles.IconContainer}>
                <Pressable android_ripple={{ color: "#504dae" }} >
